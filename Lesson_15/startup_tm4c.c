...
int const __vector_table[] @".intvec" = {
    ...
    (int)&Watchdog_IRQHandler,                  /*!< Watchdog                           */
    (int)&Timer0A_IRQHandler,                   /*!< Timer 0A                           */
    (int)&Timer0B_IRQHandler,                   /*!< Timer 0B                           */
    (int)&Timer1A_IRQHandler,                   /*!< Timer 1A                           */
    (int)&Timer1B_IRQHandler,                   /*!< Timer 1B                           */
    (int)&Timer2A_IRQHandler,                   /*!< Timer 2A                           */
    (int)&Timer2B_IRQHandler,                   /*!< Timer 2B                           */
    (int)&Comp0_IRQHandler,                     /*!< Comp 0                             */
    (int)&Comp1_IRQHandler,                     /*!< Comp 1                             */
    (int)&Comp2_IRQHandler,                     /*!< Comp 2                             */
    (int)&SysCtrl_IRQHandler,                   /*!< System Control                     */
    ...
    (int)&USART2_IRQHandler,                    /*!< UART2 Rx and Tx                    */
    ...
    (int)&I2S0_IRQHandler,                      /*!< I2S0                               */
    (int)&EBI0_IRQHandler,                      /*!< External Bus Interface 0           */
    ...
    (int)&PECI0_IRQHandler,                     /*!< PECI 0                             */
    (int)&LPC0_IRQHandler,                      /*!< LPC 0                              */
...
#pragma weak Ethernet_IRQHandler        = Unused_Handler
