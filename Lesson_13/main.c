...
int16_t sqr[] = {       // Omitting the size - compiler will infer the size from the initializer
    1*1,
    2*2,
    3*3,
    4*4
...
Point p2;                           // After typedef using, you don't have to use keyword struct anymore
